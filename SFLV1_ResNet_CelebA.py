...
mean = [0.506, 0.425, 0.382]
std = [0.265, 0.245, 0.241]
...
#                         Data loading 
#============================================================================= 
train_db = datasets.CelebA(root="/data0/HHong/data/celeba",split="train",transform=train_transforms,download=True,target_type="attr")
test_db = datasets.CelebA(root="/data0/HHong/data/celeba",split="test",transform=test_transforms,download=True,target_type="attr")
...
class CelebAData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        X = self.data[index][0]
        y = self.data[index][1][20]

        return X, y


# With augmentation
dataset_train = CelebAData(train_db)
dataset_test = CelebAData(test_db)
