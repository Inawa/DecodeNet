...
num_users = 20
epochs = 52
frac = 0.3  # participation of clients; if 1 then 100% clients participate in SFLV1
lr = 0.01
    ...
    def train(self, net):
        ...
        for iter in range(self.local_ep):
            ...
            for batch_idx, (images, labels) in enumerate(self.ldr_train):
                ...
                # if Active_piexDP:
                #     noise = DP.piexDP(fx.clone().detach()).to(self.device)
                #     client_fx = (fx.clone().detach() + noise).requires_grad_(True)
                    #print(client_fx)
...
# # With augmentation
dataset_train = datasets.MNIST("/data0/HHong/data/mnist", train=True, download=True, transform=trans_mnist)
dataset_test = datasets.MNIST("/data0/HHong/data/mnist", train=False, download=True, transform=trans_mnist)
...
#     ])
# dataset_train = datasets.CIFAR10("/data0/HHong/data/cifar10", train=True,download=True,transform=tp)
# dataset_test = datasets.CIFAR10("/data0/HHong/data/cifar10", train=False, download=True,transform=tp)
